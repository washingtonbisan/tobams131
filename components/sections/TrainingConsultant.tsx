...
export default function TrainingConsultant() {
  return (
    <section id="consultant" className="bg-brand-lavender">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-brand-muted sm:text-base">
            ...
            program will enable you to gain expertise in diverse courses
            while also developing the abilities to mentor and encourage
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {CARDS.map((card) => (
            ...
            >
              <h3 className="font-heading text-base font-semibold text-brand-dark-2">
                {card.title}
              </h3>
